...
class HomeComponent {
    ...
    ngOnInit() {
        this.service.getAllUsers().subscribe(reponse => console.log(reponse), error => console.log(error));
        this.retrieveUserById();
    }
    retrieveUserById() {
        this.service.getUserById(this.id).subscribe(reponse => console.log(reponse), error => console.log(error));
    }
}
HomeComponent.ɵfac = function HomeComponent_Factory(t) { return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"])); };
